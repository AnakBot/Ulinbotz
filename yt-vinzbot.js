...
const checkRegisteredUser = (sender) => {
    ...
    const ownerNumber = [`083838897315@s.whatsapp.net`]
...
const isRegistered = checkRegisteredUser(sender)
   const isRegister = register.includes(sender)
    ...
    const totalhit = JSON.parse(fs.readFileSync("./lib/totalcmd.json"))[0]
      ...
      const daftar1 = `Hai kak  ${pushname} ${ucapanWaktu} \n\nSebelum Menggunakan Bot subscribe dlu kak https://youtube.com/channel/UC7epajA-fFmrgggfyoeAlcw/ habis subscribe ketik Verify  Ya kak `
...
//////
			...
			tc = `MAAF KA NOMER KAMU BLOM TERDAFTAR DI DATABASE SILAHKAN KETIK !verify UNTUK MENDAFTAR DI ULINBOTZ☕`
			ind = {
...
cmhit.push(command)
    //MESS
    mess = {
        noregis: "subscribe dlu kak 1.https://youtube.com/c/BANGSHANWID\n 2.https://youtube.com/channel/UC7epajA-fFmrgggfyoeAlcw habis subscribe ketik #daftar",
...
vinz.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
    ...
    const nihkak = (teks) => {
        	grup = vinz.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/FPVL7DbelYC33Oz4m8meZ6', "groupName": `Nih kak`, "footerText": "*_© JB LINBOTZ_*", "jpegThumbnail": iye, "caption": teks}}, {quoted:mek})
            vinz.relayWAMessage(grup)
        }
        const grupinv = (teks) => {
        	grup = vinz.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/FPVL7DbelYC33Oz4m8meZ6', "groupName": `${namabot}`, "footerText": "*_© JB LINBOTZ_*", "jpegThumbnail": iye, "caption": teks}}, {quoted:mek})
            vinz.relayWAMessage(grup)
        }
const fakeitem = (teks) => {
            vinz.sendMessage(from, teks, text, {
...
const fakewa = (teks) => {        
vinz.sendMessage(from, teks, text, { thumbnail: fake, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jam} - ${week} ${weton} - ${date}`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/085157072227?text=Assalamualaikum`}}})
		}
		const fakegrup = (teks) => {        
...
"externalAdReply": {
                "title": `Whatsapp`,
                "body": `wa.me/085157072227`,
                "mediaType": "10",
                "mediaUrl": `wa.me/085157072227`,
                "thumbnailUrl": "https://j.top4top.io/p_20682m4yj0.jpg",
                "thumbnail": iye,
                "sourceUrl": `wa.me/085157072227`,
...
async function sendFileFromUrl(from, url, caption, msg, men) {
    ...
    if (isGroup && !isVote) {
      if (budy.toLowerCase() === "vote") {
        ...
        let _votes = JSON.parse(fs.readFileSync(`./lib/vote/${from}.json`));
        let fil = vote.map((v) => v.participant);
        let id_vote = sender ? sender : "085157072227@s.whatsapp.net";
        if (fil.includes(id_vote)) {
          return mentions(
            "@" + sender.split("@")[0] + " Anda sudah vote",
            fil,
...
ptod = "085157072227@s.whatsapp.net"
        stod = `${sender}`
        uwu = '*``*'
        yoii = '```'
        timestmp = speed();
...
🐥 YT Bot: https://youtube.com/channel/UC7epajA-fFmrgggfyoeAlcw
...
*┃┃* Tutor Bot :https://youtu.be/xvLoshpi3dY_
...
🐥 *𝐘𝐭 𝐁𝐨𝐭 :*https://youtube.com/c/BANGSHANWID_
🐥 𝐒𝐩𝐞𝐞𝐝 : *${latensie.toFixed(4)} _Second_*
🐥 𝐀𝐜𝐭𝐢𝐯𝐞 : *${runtime(process.uptime())}*
🐥 𝐏𝐥𝐚𝐭𝐟𝐨𝐫𝐦 : *android*
...
*┃┃*—————————————➤
*┃┣➤ *DEVELOPER* 
*┃┃* YT BOT : https://youtube.com/c/BANGSHANWID_
*┃┃* script bot ini di susun
*┃┃* oleh org dibawah ini :V
*┃┣━━━━━━━━*
*┃┃✙◗ _${namaowner}_*
...
stod = `${sender}`
       ...
       ownerJid = "6281803609324@s.whatsapp.net"
				stst = stst.status == 401 ? '' : stst.status
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
ffdm = `𝟭𝟬𝟬%  𝘼𝙈𝘼𝙉 𝘿𝘼𝙉 𝙏𝙀𝙍𝙋𝙀𝙍𝘾𝘼𝙔𝘼 𝙊𝙉𝙇𝙔 𝙄𝘿 
...
case 'ytgw':
       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fgif})
  reply('nih jan lupa subscribe yt bot 😗 https://youtube.com/c/BANGSHANWID_')
break
        		        case 'darkneon':
			case 'woodblock':
			case 'paper':
...
case 'command':
 ...
 footerText: '©𝙎𝙐𝘽𝙎𝘾𝙍𝙄𝘽𝙀 𝙔𝙏 𝙐𝙇𝙄𝙉 𝙂𝘼𝙉𝙕',
...
case 'script':
		...
		case 'sourcecode':
		if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fgif})
		vinz.sendMessage(from, { text: "cuman ambil sc? nyatim https://youtube.com/c/BANGSHANWID", matchedText: 'nyatim', description: "", title: "gak Subscribe?", jpegThumbnail: iye }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
      //------------------< Sticker Cmd >-------------------
      case "addcmd":
      case "setcmd":
...
case 'tutorbot':
      if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fgif})
  reply('Tutor Bot jangan di skip biar paham :https://youtu.be/xvLoshpi3dY_')
					break;
        case 'suit':
              if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fgif})
   try {
...
case 'setprefix':
  ...
  if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fgif})
            ...
            vinz.sendMessage(from, ini_buf, image, { thumbnail: iye, caption: `*nih kak\nBayar Pake subscribe kak ☺ https://youtube.com/c/BANGSHANWID*`, quoted: mek})
